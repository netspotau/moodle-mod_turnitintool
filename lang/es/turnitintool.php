...
$string['assigndtdue'] = 'Fecha de entrega del ejercicio';
...
$string['classupdateerror'] = 'No ha sido posible actualizar los datos de lalase Turnitin';
...
$string['configureerror'] = 'Usted debe configurar este módulo completemente como administrador antes de usuarlo dentro del curso. Por favor contacte con su administrador Moodle.';
$string['connecttest'] = 'Ejecutar una prueba de conectividad';
$string['connecttestcommerror'] = 'No se ha podido conectar a Turnitin. Compruebe nuevamente su configuración API URL.';
...
$string['filetosubmit_help'] = 'al entregar un archivo a una parte del ejercicio, busque en su ordenador el archivo que desea cargar usando los elementos de este formulario.';
...
$string['genimmediately1'] = 'Genera informes inmediatamente, el primer reporte es el final';
...
$string['norepository'] = 'No hay Repositorio';
$string['nosubmission'] = 'No hay Entregas';
$string['nosubmissions'] = 'No se ha hecho ninguna entrega';
$string['nosubmissionsdue'] = 'No hay partes activas para este ejercicio. La fecha de entrega ha pasado o la fecha de inicio no ha sido encontrada.';
...
$string['partdeletewarning'] = 'La parte del ejercicio que usted está tratando de eliminar contiene entregas. Si borra esta parte del ejercicio perderá estas entregas. ¿Está seguro que desea continuar?';
$string['partdueerror'] = 'La fecha de entrega debe ir antes de la fecha de publicación <br />';
...
$string['partstarterror'] = 'La fecha de inicio debe ir antes de la fecha de entrega. <br />';
...
$string['proxypassword_desc'] = '<b>[Opcional]</b><br />Si sus Proxys requieren autenticación ingrese la contraseña aquí';
$string['proxyport'] = 'Puerto Proxy';
$string['proxyport_desc'] = '<b>[Opcional]</b><br />Si su servidor utiliza un Proxy para conectarse a internet ingrese el puerto Proxy aquí';
$string['proxyurl'] = 'URL del Proxy';
$string['proxyurl_desc'] = '<b>[Opcional]</b><br />Si su servidor utiliza un Proxy para conectarse a internet ingrese la dirección Proxy aquí';
$string['proxyuser'] = 'Nombre de Usuario Proxy';
$string['proxyuser_desc'] = '<b>[Opcional]</b><br />Si su Proxy requiere autenticación ingrese el nombre del usuario aquí';
...
$string['resubmission'] = 'Reentrega de entrega';
$string['resubmissiongradewarn'] = 'Se permiten loos reentregas de entregas para este ejercicio hasta que la fecha de entrega pase. Todas las anotaciones serán eliminadas si y cuando el trabajo sea vuelva a entregar. ¿Desea continuar?';
...
$string['revealerror'] = 'Usted debe incluir una razón válida para revelar el nombre de un estudiante.';
...
$string['studentnotallowed'] = '<b>Note:</b>Los estudiantes no pueden ver los Reportes de Originalidad de este ejercicio.';
$string['studentreports'] = 'Reporte de Originalidad del Estudiante';
$string['studentreports_help'] = 'Permite mostrar los Reportes de Originalidad Turnitin a los estudiantes usuarios. Si está configurado a Sí, el Reporte de Originalidad generado por Turnitin estará disponible para ser visto por el estudiante.';
...
$string['submissionfileerror'] = 'Usted debe adjuntar un archivo a entregar';
...
$string['submissiontexterror'] = 'Usted debe incluir el texto para esta entrega';
$string['submissiontitle'] = 'Título de la Entrega';
$string['submissiontitle_help'] = 'Introduzca el título de la entrega para el trabajo que está entregando.';
$string['submissiontitleduplicate'] = 'Usted tiene que ingresar un título diferente por cada entrega';
$string['submissiontitleerror'] = 'Necesita incluir un título para esta entrega';
$string['submissiontype'] = 'Tipo de Entrega';
$string['submissiontype_help'] = '<p>Indica los tipos de entrega(s) que usted puede hacer a Turnitin. Las opciones son:</p>';
...
$string['texttosubmit_help'] = 'Copie y pegue el texto de su entrega en este cuadro.';
$string['title'] = 'Título';
...
$string['turnitinanon_help'] = 'Usted puede configurar las Anotaciones Anónimas en los ejercicios Turnitin ajustando de este valor a Sí. Las Anotaciones Anónimas no pueden ser deshabilitadas una vez se han habilitado en un ejercicio .';
$string['turnitinapiurl'] = 'URL del API de Turnitin';
$string['turnitinapiurl_desc'] = '<b>[Requerido]</b><br />Ingrese el URL del API de Turnitin <br /><i>(e.g. https://www.turnitin.com/api.asp)<br />(e.g. https://submit.ac.uk/api.asp)</i>';
...
$string['turnitindeleteconfirm'] = 'Eliminar trabajos los saca de su lista de entregas y su bandeja de entrada pero no los elimina \n por completo de la base de datos Turnitin. \n\n ¿Está seguro que desea elimirar esta entrega? Esta acción no es reversible.';
...
$string['turnitinsecretkey_desc'] = '<b>[Requerido]</b><br />Introduzca su clave compartida de Turnitin<br /><i>(Configurada por su administrador de Turnitin )</i>';
...
$string['turnitintoolagreement_desc'] = '<b>[Requerido]</b><br />Introduzca la declaración de confirmación del acuerdo para las entregas.';
...
$string['turnitintoolresetinfo'] = 'Seleccione una de las opciones abajo para los ejercicios Turnitin en este curso.';
...
$string['turnitinuseanon_desc'] = 'Seleccione si desea permitir Marcas Anónimas para evaluar entregas.<br /><i>(Esta opción sólo está disponible para aquellos que han configurado Anotaciones Anónimas en sus cuentas)</i>';
$string['turnitinusegrademark'] = 'Usar GradeMark';
$string['turnitinusegrademark_help'] = 'Use esta configuración para usar Turnitin GradeMark o Moodle para evaluar las entregas.';
...
$string['turnitinuserepository_desc'] = 'Seleccione si desea permitir el uso del Repositorio Institucional para los ejercicios Turnitin.<br /><i>(Esta opción sólo está disponible para aquellos que han habilitado un Repositorio Institucional en sus cuentas)';
...
$string['updatingreport'] = 'Recuperando la puntuación del reporte Turnitin';
...
$string['turnitinuseerater_desc'] = 'Elija habilitar o no ETS&copy; revisión de gramática. <br/><i>(Habilitar esta opción sólo si ETS&copy; e-rater está habilitado en su cuenta Turnitin)<i>';
